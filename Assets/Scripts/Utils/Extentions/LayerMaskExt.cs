// source: http://wiki.unity3d.com/index.php?title=LayerMaskExtensions
// with my additions
...
public static class LayerMaskExt
{
    ...
    public static LayerMask AddToMask(this LayerMask original, params int[] layers)
    {
        return original | LayerNumbersToMask(layers);
    }

    public static LayerMask AddToMask(this LayerMask original, LayerMask mask)
    {
